...
<template>
  <div v-if="stems.length > 0">
    <el-space :size="30" wrap>
      <WordCard v-for="(o, key) in stems" :key="key" :stem="o.term" :id="o.id" class="word-card">
        <template #body>
          <el-menu mode="horizontal" :ellipsis="false">
            <el-menu-item index="1" @click="activeTab='0';getWordsByStemId(o, key)">
          ...
          <el-tabs type="border-card">
            <el-tab-pane label="词汇解释">
              <el-row>
                ...
                <el-col :span="7">
                  <el-text size="small">{{
                    new Date(o.lastModified).toLocaleString('zh-CN')
                  }}</el-text>
                </el-col>
              </el-row>
            ...
            <el-tab-pane label="关联词汇">
              asdf
            </el-tab-pane>
            <el-tab-pane label="历史记录" lazye="true">
              <ChallengeHistory :id="o.id"></ChallengeHistory>
            </el-tab-pane>
          </el-tabs>
        </template>
      </WordCard>
